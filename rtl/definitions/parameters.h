...
`else
    `ifndef PARAMETERS
        ...
        `define SINGLE_PRECISION_FLOAT_POINT_NUMBER             ((FLOAT_POINT_NUMBER_PRECISION_TYPE_WIDTH)'b0)
        `define DOUBLE_PRECISION_FLOAT_POINT_NUMBER             ((FLOAT_POINT_NUMBER_PRECISION_TYPE_WIDTH)'b1)

        `define FLOAT_POINT_FORMAT_NEGATIVE_INFINITY            ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_0000_0001)
        `define FLOAT_POINT_FORMAT_NEGATIVE_NORMAL_NUMBER       ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_0000_0010)
        `define FLOAT_POINT_FORMAT_NEGATIVE_SUBNORMAL_NUMBER    ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_0000_0100)
        `define FLOAT_POINT_FORMAT_NEGATIVE_ZERO                ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_0000_1000)
        `define FLOAT_POINT_FORMAT_POSITIVE_ZERO                ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_0001_0000)
        `define FLOAT_POINT_FORMAT_POSITIVE_SUBNORMAL_NUMBER    ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_0010_0000)
        `define FLOAT_POINT_FORMAT_POSITIVE_NORMAL_NUMBER       ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_0100_0000)
        `define FLOAT_POINT_FORMAT_POSITIVE_INFINITY            ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b00_1000_0000)
        `define FLOAT_POINT_FORMAT_SIGNALING_NAN                ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b01_0000_0000)
        `define FLOAT_POINT_FORMAT_QUIET_NAN                    ((FLOAT_POINT_NUMBER_FORMAT_WIDTH)'b10_0000_0000)
