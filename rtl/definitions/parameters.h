...
`define UNIFIED_CACHE_PACKET_CRITICAL_POS               (`UNIFIED_CACHE_PACKET_CACHEABLE_POS + 1)

`define UNIFIED_CACHE_PACKET_WIDTH_IN_BITS              (`UNIFIED_CACHE_PACKET_CRITICAL_POS - `UNIFIED_CACHE_PACKET_ADDR_POS_LO + 1)
